...
sourcesIndex["pliantdb_core"] = {"name":"","dirs":[{"name":"document","files":["revision.rs"]},{"name":"kv","dirs":[{"name":"implementation","files":["get.rs","namespaced.rs","set.rs"]}],"files":["timestamp.rs"]},{"name":"permissions","files":["group.rs","mod.rs","pliant.rs","role.rs"]},{"name":"schema","dirs":[{"name":"view","files":["map.rs"]}],"files":["collection.rs","mod.rs","names.rs","schematic.rs","view.rs"]}],"files":["backend.rs","connection.rs","document.rs","kv.rs","lib.rs","limits.rs","networking.rs","pubsub.rs","test_util.rs","transaction.rs"]};
