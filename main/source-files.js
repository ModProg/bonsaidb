...
sourcesIndex["pliantdb_core"] = {"name":"","dirs":[{"name":"document","files":["revision.rs"]},{"name":"kv","files":["get.rs","namespaced.rs","set.rs"]},{"name":"schema","dirs":[{"name":"view","files":["map.rs"]}],"files":["collection.rs","mod.rs","names.rs","schematic.rs","view.rs"]}],"files":["connection.rs","document.rs","kv.rs","lib.rs","limits.rs","networking.rs","pubsub.rs","test_util.rs","transaction.rs"]};
sourcesIndex["pliantdb_jobs"] = {"name":"","dirs":[{"name":"manager","files":["jobs.rs","managed_job.rs"]}],"files":["lib.rs","manager.rs","task.rs","traits.rs"]};
sourcesIndex["pliantdb_local"] = {"name":"","dirs":[{"name":"storage","files":["kv.rs"]},{"name":"views","files":["integrity_scanner.rs","mapper.rs"]}],"files":["backup.rs","config.rs","error.rs","lib.rs","open_trees.rs","storage.rs","tasks.rs","views.rs"]};
