...
sourcesIndex["pliantdb_core"] = {"name":"","dirs":[{"name":"document","files":["revision.rs"]},{"name":"schema","dirs":[{"name":"view","files":["map.rs"]}],"files":["collection.rs","mod.rs","schematic.rs","view.rs"]}],"files":["connection.rs","document.rs","lib.rs","limits.rs","networking.rs","pubsub.rs","test_util.rs","transaction.rs"]};
