...
sourcesIndex["bonsaidb"] = {"name":"","files":["cli.rs","lib.rs"]};
...
sourcesIndex["bonsaidb_jobs"] = {"name":"","dirs":[{"name":"manager","files":["jobs.rs","managed_job.rs"]}],"files":["lib.rs","manager.rs","task.rs","traits.rs"]};
sourcesIndex["bonsaidb_local"] = {"name":"","dirs":[{"name":"database","files":["kv.rs","pubsub.rs"]},{"name":"storage","files":["kv.rs"]},{"name":"views","files":["integrity_scanner.rs","mapper.rs"]}],"files":["backup.rs","config.rs","database.rs","error.rs","lib.rs","open_trees.rs","storage.rs","tasks.rs","vault.rs","views.rs"]};
